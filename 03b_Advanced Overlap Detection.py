...
display(cargos_indexed.limit(10))
...
display(spark.read.table("ship_path").limit(10))

# COMMAND ----------

to_plot = spark.read.table("ship_path").select("buffer").limit(1_000).distinct()

# COMMAND ----------

# DBTITLE 1,Example Buffer Paths
# MAGIC %%mosaic_kepler
# MAGIC to_plot "buffer" "geometry" 1_000
...
# MAGIC %sql
# MAGIC SELECT * FROM ship2ship.overlap_candidates_lines limit 10;
...
# MAGIC %%mosaic_kepler
# MAGIC ship2ship.overlap_candidates_lines_filtered "line_1" "geometry" 500
